...
class LinearTrajectory(Trajectory):
    ...
    def __init__(self, total_time, init_pos, end_pos):
        ...
        # -- Find the vector eq that goes through the current position & the end_coord - #
    ...
    def quadratic_speed_model(self, time):
        ...
        # -------------------------- Find the coefficient b -------------------------- #
        b = distance / (-self.total_time**3/3 + self.total_time**2/2)

        return b * (-(time - self.total_time/2)**2 + (self.total_time/2)**2)
